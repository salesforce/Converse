...
var jqtree = function (e, t) {
    ...
    var r = o(t), i = n(t), s = function (e, t) {
    ...
    var h = {before: l.Before, after: l.After, inside: l.Inside, none: l.None}, u = function (e) {
        ...
        return e.prototype.setData = function (e) {
            if (e) if ("string" == typeof e) this.name = e; else if ("object" == typeof e) for (var t in e) if (Object.prototype.hasOwnProperty.call(e, t)) {
                var o = e[t];
            ...
            var t = function (e) {
                return e.map((function (e) {
                    var o = {};
                    for (var n in e) if (-1 === ["parent", "children", "element", "idMapping", "load_on_demand", "nodeClass", "tree", "isEmptyFolder"].indexOf(n) && Object.prototype.hasOwnProperty.call(e, n)) {
                        var r = e[n];
                        o[n] = r
                    }
            ...
            if (this.parent) {
                var t = this.createNode(e), o = this.parent.getChildIndex(this);
        ...
        return e.prototype.mouseCapture = function (e) {
            ...
            this.refresh();
            var o = c(e.target).offset(), n = o ? o.left : 0, r = o ? o.top : 0, i = this.currentItem.node;
            ...
            if (this.currentItem && this.hoveredArea && this.hoveredArea.position !== l.None && this.canMoveToArea(this.hoveredArea)) {
                var o = this.currentItem.node, n = this.hoveredArea.node, r = this.hoveredArea.position, i = o.parent;
            ...
            if (e) {
                var t = this.treeWidget.element, o = t.width() || 0, n = t.height() || 0,
        ...
        return e.prototype.iterate = function () {
            var e = this, t = !0, o = function (n, r) {
                var i = (n.is_open || !n.element) && n.hasChildren(), s = null;
                if (n.element) {
        ...
        return e.prototype.render = function (e) {
            ...
            var n = this.getButtonClasses(e), r = this.getFolderClasses(e, o),
                i = e.is_open ? this.openedIconElement : this.closedIconElement, s = document.createElement("li");
            ...
            var i = document.createElement("span"), s = "jqtree-title jqtree_common";
        ...
        return e.prototype.loadFromUrl = function (e, t, o) {
            ...
            var t = this.treeWidget.options.dataFilter, o = "string" == typeof e ? JSON.parse(e) : e;
            return t ? t(o) : o
        }, e
    }(), S = function () {
        function e(t) {
        ...
        return a(t, e), t.prototype.init = function () {
            var e = this.$el.get(0);
            e.addEventListener("mousedown", this.mouseDown, {passive: !1}), e.addEventListener("touchstart", this.touchStart, {passive: !1}), this.isMouseStarted = !1, this.mouseDelayTimer = null, this.isMouseDelayMet = !1, this.mouseDownInfo = null
        }, t.prototype.deinit = function () {
            var e = this.$el.get(0);
            e.removeEventListener("mousedown", this.mouseDown, {passive: !1}), e.removeEventListener("touchstart", this.touchStart, {passive: !1}), this.removeMouseMoveEventListeners()
            ...
            document.addEventListener("mousemove", this.mouseMove, {passive: !1}), document.addEventListener("touchmove", this.touchMove, {passive: !1}), document.addEventListener("mouseup", this.mouseUp, {passive: !1}), document.addEventListener("touchend", this.touchEnd, {passive: !1});
            ...
            document.removeEventListener("mousemove", this.mouseMove, {passive: !1}), document.removeEventListener("touchmove", this.touchMove, {passive: !1}), document.removeEventListener("mouseup", this.mouseUp, {passive: !1}), document.removeEventListener("touchend", this.touchEnd, {passive: !1})
        }, t
    }(D), j = function () {
        function e(e) {
            this.treeWidget = e
        ...
        return e.prototype.saveState = function () {
            ...
            return {
                ...
                })), t), selected_node: (e = [], o.treeWidget.getSelectedNodes().forEach((function (t) {
            ...
            for (var t = !1, o = 0, n = e; o < n.length; o++) {
                var r = n[o], i = this.treeWidget.getNodeById(r);
            ...
            var n = this, r = 0, i = e, s = function () {
                for (var e = [], s = 0, l = i; s < l.length; s++) {
                    var d = l[s], h = n.treeWidget.getNodeById(d);
        ...
        return e.prototype.checkScrolling = function () {
            ...
            if (this.ensureInit(), this.$scrollParent) this.$scrollParent[0].scrollTop = e; else {
                var t = this.treeWidget.$el.offset(), o = t ? t.top : 0;
            ...
            if (void 0 !== e.pageX && void 0 !== e.pageY) {
                var t = this.$scrollParent, o = t && t.offset();
                if (t && o) {
                    var n = t[0], r = n.scrollLeft + n.clientWidth < n.scrollWidth, i = n.scrollLeft > 0,
                        s = o.left + n.clientWidth, a = o.left, l = e.pageX > s - 20, d = e.pageX < a + 20;
        ...
        return e.prototype.getSelectedNode = function () {
            ...
            var t = [];
            for (var o in this.selectedNodes) if (Object.prototype.hasOwnProperty.call(this.selectedNodes, o)) {
    ...
    }(), H = r.default || i, A = "Node parameter is empty", M = "Parameter is empty: ", P = function (e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
        ...
        return a(t, e), t.prototype.toggle = function (e, t) {
            ...
            var o = null != t ? t : this.tree, n = o.prepend(e);
            return this._refreshElements(o), n
            ...
            var n = this.selectNodeHandler.isFocusOnTree(), r = this.isSelectedNodeInSubtree(e);
            ...
            if (!e) throw Error(A);
            var t = H(e.element).offset(), o = t ? t.top : 0, n = this.$el.offset(), r = o - (n ? n.top : 0);
            ...
            if (e.isFolder() || e.isEmptyFolder) if (e.load_on_demand) this.loadFolderOnDemand(e, t, o); else {
            ...
            var t, o = this, n = this.options.dataUrl || this.element.data("url"), r = function (t) {
            ...
            return o || (n = function () {
                ...
                var t = e.getAutoOpenMaxLevel(), o = !1;
            ...
            var t = H(e), o = t.closest(".jqtree-toggler");
            if (o.length) {
    ...
    return D.register(P, "tree"), e.JqTreeWidget = P, Object.defineProperty(e, "__esModule", {value: !0}), e
}({}, jQuery);
